...
4. **Extrair ticket Jira do nome do ramo**
   ...
   - Se nenhum ID de ticket for encontrado no nome do branch, peça um ao usuário ou prossiga sem ele.
...
6. **Gere o título do PR**
   ...
   - Se não houver nenhum ticket Jira disponível, use um escopo de módulo ou omita o escopo completamente.
